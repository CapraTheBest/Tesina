<?php
	...
	$query = "SELECT ROUND(avg(humidity),2) AS 'humidity', DATE(time) AS 'time' FROM `pianta` GROUP BY DATE(time)";
	...
	$MyData->setSerieWeight("Humidity",1); 
	...
	$myPicture->drawText(150,35,"Average humidity",array("FontSize"=>20,"Align"=>TEXT_ALIGN_BOTTOMMIDDLE)); 
